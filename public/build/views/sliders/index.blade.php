            ...
            <div class="card-body table-responsive">
                <div class="row mb-2">
                    <div class="col-md-4 mb-2">
                        <form method="get">
                          <input type="text" class="form-control" name="name" placeholder="Cari nama slider" value="{{ request('name') }}">
                        </form>
                    </div>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $slider->name }}</td>
                            <td><a href="{{ $slider->url }}" target="_blank">Klik Disini</td>
                            <td>{{ parse_date($slider->start_date) }} - {{ parse_date($slider->end_date) }}</td>
                            <td>
                                <a href="{{ $slider->picture->url }}" target="_blank">
                                    <img src="{{ $slider->picture->url }}" class="w-50" style="border-radius: 0px"></td>
                                </a>
                            <td>
