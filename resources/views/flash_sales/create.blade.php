            ...
            <div class="card-body">
                <form method="POST" action="{{ $storeLink }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control {{ $errors->has('start_date') ? ' is-invalid' : '' }}" name="start_date" id="start_date" placeholder="Masukkan Nama" value="{{ old('start_date') }}">
                        @include('alerts.feedback', ['field' => 'start_date'])
                    </div>
                    <div class="form-group">
                        <label for="end_date">Tanggal berakhir</label>
                        <input type="datetime-local" class="form-control {{ $errors->has('end_date') ? ' is-invalid' : '' }}" name="end_date" id="end_date" placeholder="Masukkan Nama" value="{{ old('end_date') }}">
                    ...
                    <div id="product_item_div">
                        ...
                        <div style="max-height: 300px; overflow-y: scroll; overflow-x: hidden">
                          <x-search-product-item-flash-sale />
                        </div>
                        <hr>
                    </div>
