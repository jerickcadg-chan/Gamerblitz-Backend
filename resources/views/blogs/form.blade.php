        ...
        <form method="POST" action="{{ $formAction }}" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              ...
              <select id="blog_category_select"
                      name="blog_category_id"
                      class="form-control {{ $errors->has('blog_category_id') ? 'is-invalid' : '' }}"
                      data-placeholder="Select or type to add..."
                      required>
                <option value=""></option>
          ...
          <div class="form-group">
            ...
            <textarea name="meta_description" class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" rows="3">{{ old('meta_description', $blog->meta_description) }}</textarea>
          ...
          <div class="row">
            <div class="form-group col-md-6">
              ...
              @if($isEdit && $blog->thumbnail)
                <div class="mt-2">
                  <img src="{{ asset('storage/'.$blog->thumbnail) }}" alt="thumb" style="height:80px">
                </div>
              @endif
