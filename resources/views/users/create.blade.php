      ...
      <div class="card-body">
        <form method="POST" action="{{ $storeLink }}">
          ...
          <div class="form-group">
            ...
            <input type="email" name="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" id="input_email" placeholder="Enter email" value="{{ old('email') }}" required>
            @include('alerts.feedback', ['field' => 'email'])
          </div>
          <div class="form-group">
            <label for="input_phone_number">Phone Number</label>
            <input type="text" name="phone_number" class="form-control {{ $errors->has('phone_number') ? ' is-invalid' : '' }}" id="input_phone_number" placeholder="Enter phone number" value="{{ old('phone_number') }}">
          ...
          <div class="form-group">
            ...
            <input type="password" name="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" id="input_password" placeholder="Enter password" required>
            @include('alerts.feedback', ['field' => 'password'])
          </div>
          <div class="form-group">
            <label for="input_password_confirmation" class="required">Repeat Password</label>
            <input type="password" name="password_confirmation" class="form-control {{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}" id="input_password_confirmation" placeholder="Repeat password entered" required>
