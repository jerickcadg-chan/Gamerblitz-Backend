...
@section('content')
    ...
    {{--                     <input type="text" name="code" class="form-control {{ $errors->has('code') ? ' is-invalid' : '' }}" id="input_code" placeholder="Masukkan nama" value="{{ old('code') }}" required> --}}
    ...
    {{--                             <input type="number" name="price" class="form-control {{ $errors->has('price') ? ' is-invalid' : '' }}" id="input_price" placeholder="Masukkan harga umum" value="{{ old('price') }}" min="1" required> --}}
    ...
    {{--                             <input type="number" name="price_reseller" class="form-control {{ $errors->has('price_reseller') ? ' is-invalid' : '' }}" id="input_price_reseller" placeholder="Masukkan harga reseller" value="{{ old('price_reseller') }}" min="1" required> --}}
    ...
    {{--                     <input type="number" name="capital" class="form-control {{ $errors->has('capital') ? ' is-invalid' : '' }}" id="input_capital" placeholder="Masukkan modal" value="{{ old('capital') }}" min="1" required> --}}
    {{--                     @include('alerts.feedback', ['field' => 'capital']) --}}
    {{--                 </div> --}}
    {{--                 <div class="form-group"> --}}
    {{--                     <label for="input_stock" class="required">Stok</label> --}}
    {{--                     <input type="number" name="stock" class="form-control {{ $errors->has('stock') ? ' is-invalid' : '' }}" id="input_stock" placeholder="Masukkan stok" value="{{ old('stock') }}" min="1" required> --}}
