      ...
      <div class="card-body">
        <form method="POST" action="{{ route('setting.update') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label>Logo</label>
            <div class="mb-2">
              @if(!empty($settings['logo_url'])) <img src="{{ $settings['logo_url'] }}" alt="Logo" style="height:64px"> @endif
            </div>
          ...
          <div class="form-group">
            <label>Favicon</label>
            <div class="mb-2">
              @if(!empty($settings['favicon_url'])) <img src="{{ $settings['favicon_url'] }}" alt="Favicon" style="height:48px"> @endif
            </div>
          ...
          {{-- Pop Up Setting --}}
          <h4 class="mt-5 mb-2">Pop Up Setting</h4>
          <hr class="mb-4">
          ...
          <div class="form-group">
            ...
            <div class="mb-2">
              @if(!empty($settings['popup_image_url'])) <img src="{{ $settings['popup_image_url'] }}" alt="Popup" style="height:80px"> @endif
            </div>
          ...
          <h4 class="mt-5 mb-2">Terms and Conditions</h4>
          <hr class="mb-4">
