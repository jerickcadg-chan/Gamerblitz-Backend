    ...
    public function run()
    {
        ...
        Product::insert([
            [
                ...
                'how_to_order' => '<p><b>Cara Melihat Player ID / Server ID Mobile Legends</b></p><p><img src="https://kayestore.com/assets/img/game/ml.jpg" class="w-100"></p><p>Untuk mengetahui informasi player ID dan server ID Mobile Legends, silahkan masuk ke menu "profile", lalu lihat bagian kanan atas.</p>',
                'slug' => 'mobile-legends',
                'status' => 'active',
                'created_at' => now(),
                'updated_at' => now()
            ...
            [
                ...
                'how_to_order' => '<p><b>Cara Melihat Player ID Free Fire</b></p><p><img src="https://kayestore.com/assets/img/game/ff.jpg" class="w-100"></p><p>Untuk menemukan informasi Player ID Free Fire dengan membuka menu "profile akun". Player ID terletak di bawah foto dan nama akun.</p>',
                'slug' => 'free-fire',
                'status' => 'active',
                'created_at' => now(),
                'updated_at' => now()
            ...
            [
                ...
                'how_to_order' => '<p><b>Cara Melihat Player ID Pubg Mobile</b></p><p><img src="https://kayestore.com/assets/img/game/pubg.jpg" class="w-100"></p><p>Untuk menemukan informasi Player ID PUBG Mobile dengan membuka "profil" Di sana akan terlihat Player ID akun kamu</p>',
                'slug' => 'pubg-mobile',
                'status' => 'active',
                'created_at' => now(),
                'updated_at' => now()
            ...
            [
                ...
                'how_to_order' => '<p><b>Cara Melihat UID Genshin Impact</b></p><p><img src="https://kayestore.com/assets/img/game/genshin.jpg" class="w-100"></p><p>Untuk menemukan informasi UID Genshin Impact dengan melihat informasi UID di bagian pojok kanan bawah layar permainan</p>',
                'slug' => 'genshin-impact',
                'status' => 'active',
                'created_at' => now(),
                'updated_at' => now()
            ...
            [
                ...
                'how_to_order' => '<p><b>Cara Melihat Riot ID LoL - Wild Rift</b></p><p><img src="https://kayestore.com/assets/img/game/lol.jpg" class="w-100"></p><p>Untuk menemukan informasi Riot ID LoL - Wild Rift dengan membuka menu "profile akun". Riot ID terletak di bawah foto dan nama akun.</p>',
                'slug' => 'lol-wild-rift',
                'status' => 'active',
                'created_at' => now(),
                'updated_at' => now()
            ...
            [
                ...
                'how_to_order' => '<p><b>Cara Melihat User ID Sausage Man</b></p><p><img src="https://kayestore.com/assets/img/game/sausage.jpg" class="w-100"></p><p>Masuk ke lobby Sausage Man, kemudian tap icon “Baris Tiga”. ID akun Sausage Man berada di sebelah kanan tombol “Ganti Akun” atau yang saya tandai “Arrow”.</p>',
                'slug' => 'sausage-man',
                'status' => 'active',
                'created_at' => now(),
                'updated_at' => now()
